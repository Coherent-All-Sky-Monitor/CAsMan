...
class TestDevServer:
    ...
    def test_run_dev_server_prints_info(
        self, mock_print, mock_create_app, mock_init_db
    ):
        ...
        assert any(
            "Scanner interface" in str(call) for call in mock_print.call_args_list
        )
...
class TestProductionServer:
    ...
    @patch("casman.web.server.create_app")
    @patch("builtins.print")
    def test_run_production_server_custom_workers(
        self, mock_print, mock_create_app, mock_init_db
    ):
    ...
    @patch("casman.web.server.init_all_databases")
    @patch("casman.web.server.create_app")
    def test_run_production_server_custom_host_port(
        self, mock_create_app, mock_init_db
    ):
