...
Features
--------
- Supports part types: ANTENNA, LNA, BACBOARD.
...
def save_to_db(part_number, part_type):
    """
    ...
    try:
        ...
        c = conn.cursor()
        c.execute(
            "INSERT INTO parts (part_number, part_type, created_at, modified_at) VALUES (?, ?, ?, ?)",
...
def generate_parts(part_type, count):
    """
    ...
    -------
    list of str
        A list of generated part numbers.
    """
...
def generate_barcode(part_number, directory):
    """
