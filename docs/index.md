...
Welcome to the CAsMan (CASM Assembly Manager) documentation.

## Getting Started

- [Overview and Quick Start](main.md) - Start here for an introduction to CAsMan
...
*Note: Auto-generated docs are created by running `python docs/generate_docs.py` and provide technical API details extracted directly from the python docstrings.*
